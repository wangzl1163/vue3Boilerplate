	...
	methods: {
		...
		getPassword() {
			...
			this.loginForm = {
				...
				password: password === undefined ? this.loginForm.password : decryption(password, settings.aesKey, settings.aesIv),
		...
		handleLogin() {
			this.$refs.loginForm.validate((valid) => {
              ...
              if (this.loginForm.rememberMe) {
								...
								localStorage.setItem('password', encryption(this.loginForm.password,settings.aesKey, settings.aesIv))
