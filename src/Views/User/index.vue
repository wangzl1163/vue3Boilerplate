        ...
        <el-card class="box-card">
          ...
          <div>
            <div class="text-center">
              <img v-bind:src="avatar" title="头像" class="img-circle img-lg" />
            </div>
            <ul class="list-group list-group-striped">
              ...
              <li class="list-group-item">
                ...
                <div class="pull-right">{{ userInfo.phone_number }}</div>
              </li>
              <li class="list-group-item">
              ...
              <li class="list-group-item">
                ...
                <div class="pull-right">{{ userRoles.join(',') === 'admin' ? '管理员' : '用户' }}</div>
              </li>
              <li class="list-group-item">
