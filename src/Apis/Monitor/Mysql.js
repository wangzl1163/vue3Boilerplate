/*
 * @Description: MySQL监控api
 * @Author: 王占领
 * @Date: 2021-06-03 14:43:10
 * @LastEditTime: 2021-06-04 14:15:04
 * @LastEditors: 王占领
 * @FilePath: \ctfo-monitor-logging-front\micro-web\client\src\Apis\Monitor\Mysql.js
 */
import { wrapLabelsData, wrapQuery, wrapQueryRange } from './CreateRequest';
import { createApi } from './ApiFactory';

const query = (metrics, params) => wrapQuery('database_mysql')('monitor-master', metrics, params)
const queryRange = (metrics, params) => wrapQueryRange('database_mysql')('monitor-master', metrics, params)
