      ...
      GenerateRoutes({ getters, commit }) {
         return new Promise(resolve => {
            ...
            const clientRoute = {
               ...
               path: 'client',
               name: 'client',
               meta: { title: '客户端管理', icon: 'xitongguanli', noCache: true }
            }
            const sourceRoute = {
               moduleCode: 'source',
               path: 'source',
            ...
            const loggerRoute = {
               ...
               children: isAdmin ? [searchRoute, clientRoute, sourceRoute] : [searchRoute]
            }
            const configRoute = {
               order: 4,
               moduleCode: 'config',
            ...
            const routeList = isAdmin ? [loggerRoute, configRoute] : [loggerRoute]
